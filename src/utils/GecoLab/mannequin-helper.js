...
export var MANNEQUIN_TEXTS = [
  ...
  "Super! Wenn du den Tiegel positioniert hast, zündest du den Bunsenbrenner mit dem Feuerzeug an, legst das Feuerzeug wieder zurück. Wenn du mit Feuer arbeitest, musst du die richtigen Handschuhe anziehen.",
  ...
  "Denk auch daran, dass du die Temperatur messen solltest, um zu kontrollieren, dass die Probe nicht zu heiß ist. Sollte die Temperatur über 500°C liegen musst du den Bunsenbrenner nach unten drehen. Leg das Thermometer wieder auf der Arbeitsfläche ab und rühr die Probe noch einmal.",
...
export var MANNEQUIN_TEXTS_EXTRA = [
  ...
  "",
  "",
  "Wenn du den Button „Rühren“ gedrückt hältst , läuft die Stoppuhr schneller.",
  "Stelle das Thermometer in den Tiegel und achte auf die Temperatur. Lege das Thermometer anschließend wieder auf die Arbeitsfläche.",
  "Wenn du den Button „Rühren“ gedrückt hältst , läuft die Stoppuhr schneller.",
  "",
  "",
