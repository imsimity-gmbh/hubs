...
function createId(length) {
  ...
  export function getExperimentDataFromParent(entity)
  {
    ...
    parent = entity.closest('#second-experiment-04-wrapper');
  
    if (parent != null)
    {
      return parent.components['second-experiment-04'].experimentData;
    }

    parent = entity.closest('#second-experiment-05-wrapper');
  
    if (parent != null)
    {
      return parent.components['second-experiment-05'].experimentData;
    }
    
    parent = entity.closest('#second-experiment-06-wrapper');
    ...
    parent = entity.closest('#third-experiment-01-wrapper');
  
    if (parent != null)
    {
      return parent.components['third-experiment-01'].experimentData;
    }

    parent = entity.closest('#third-experiment-02-wrapper');
  
    if (parent != null)
    {
      return parent.components['third-experiment-02'].experimentData;
    }

    parent = entity.closest('#third-experiment-03-wrapper');
  
    if (parent != null)
    {
      return parent.components['third-experiment-03'].experimentData;
    }

    parent = entity.closest('#third-experiment-04-wrapper');
  
    if (parent != null)
    {
      return parent.components['third-experiment-04'].experimentData;
    }

    parent = entity.closest('#third-experiment-05-wrapper');
  
    if (parent != null)
    {
      return parent.components['third-experiment-05'].experimentData;
    }
