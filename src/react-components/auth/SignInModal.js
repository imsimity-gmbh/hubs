  ...
  return (
    <Column center padding>
      <FormattedMessage
        ...
        defaultMessage="<p>Email sent to {email}!</p><p>To continue, click on the link in the email using your phone, tablet, or PC.</p><p>No email? You may not be able to create an account. Be sure to check your spam folder as well.</p>"
