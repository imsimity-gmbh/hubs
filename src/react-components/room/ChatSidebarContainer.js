    ...
    () => {
      function onReceiveMessage(event) {
        ...
        if (newMessage.type === "gecolab-spawn")
        {
          ...
          {
            spawnOrDeleteExperiment(data.position, data.groupCode, scene, data.experiment);
          }
        }
      }
