...
import { ShowFormulaResultClayModalContainer } from "./ShowFormulaResultClayModalContainer";
...
export function EnterFormulaClayModal ({ scene, showNonHistoriedDialog, onClose, groupCode }) {
    ...
    function handleSubmit(e) {
        ...
        showNonHistoriedDialog(
            ShowFormulaResultClayModalContainer, { scene: scene, onClose: onClose, result: resultTxt, groupCode: groupCode }
        )
        ...
        >
            ...
            <div class="modal-wrapper">
                ...
                <form class="enter-formula-form" onSubmit={handleSubmit}>
                    <div
                    >
                        <label for="input-a">a = Masse Ton-/Schlufffraktion (in g)<br/></label>
...
EnterFormulaClayModal.propTypes = {
